...
const getAllHeatPoints = (GPSBubble, Slider, Animal) => {
  ...
  // console.log("DB GETS", Slider, Animal)
 ...
 let SliderAdd = Slider + 1

 return db.query(`SELECT * FROM heatPoints WHERE lat BETWEEN $1 AND $2 AND lng BETWEEN $3 AND $4 AND animal Like $5 AND "month" = $6`, [minLat, maxLat, minLng, maxLng, Species, SliderAdd])
 .then((response) => {
