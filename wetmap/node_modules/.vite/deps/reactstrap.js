import {
  Transition_default
} from "./chunk-XEESFNTX.js";
import {
  createPopper,
  init_lib
} from "./chunk-RUZMSZKW.js";
import "./chunk-V4AIBIPH.js";
import {
  require_prop_types
} from "./chunk-4FG734S6.js";
import "./chunk-JIL2JRMU.js";
import {
  require_react_dom
} from "./chunk-S76LC3PL.js";
import {
  require_react
...
var propTypes$1e = {
  ...
  horizontal: import_prop_types.default.string,
...
var NavLink = class extends import_react.default.Component {
  ...
  render() {
    let _this$props = this.props, {
      ...
      tag: Tag,
      innerRef
    } = _this$props, attributes = _objectWithoutProperties(_this$props, _excluded$16);
...
function Button(props) {
  ...
  let {
    ...
    tag: Tag,
    innerRef
  } = props, attributes = _objectWithoutProperties(props, _excluded$12);
  if (close) {
    return import_react.default.createElement(CloseButton$1, attributes);
  }
...
var ButtonToggle = class extends import_react.default.Component {
  constructor(props) {
    super(props);
    this.state = {
...
var DropdownToggle = class extends import_react.default.Component {
  ...
  render() {
    ...
    return import_react.default.createElement(Reference, {
      ...
      ref
    }) => import_react.default.createElement(Tag, _extends({}, props, {
...
var UncontrolledAccordion = (_ref) => {
  ...
  return import_react.default.createElement(Accordion$1, _extends({}, props, {
    open,
    toggle
  }));
};
  ...
  render() {
    ...
    const slides = items.map((item) => {
      ...
      return import_react.default.createElement(CarouselItem$1, {
        ...
        src: item.src,
        alt: item.altText
      }), import_react.default.createElement(CarouselCaption$1, {
    ...
    }, props), indicators && import_react.default.createElement(CarouselIndicators$1, {
      items,
      activeIndex: props.activeIndex || activeIndex,
      onClickHandler: goToIndex || this.goToIndex
    }), slides, controls && import_react.default.createElement(CarouselControl$1, {
      direction: "prev",
      directionText: "Previous",
      onClickHandler: props.previous || this.previous
    }), controls && import_react.default.createElement(CarouselControl$1, {
      direction: "next",
      directionText: "Next",
...
var UncontrolledPopover = class extends import_react.Component {
  ...
  render() {
    return import_react.default.createElement(Popover$1, _extends({
      isOpen: this.state.isOpen,
      toggle: this.toggle
...
var propTypes$o = {
  tag: tagPropType,
  type: import_prop_types.default.bool,
  size: import_prop_types.default.string,
  className: import_prop_types.default.string,
  cssModule: import_prop_types.default.object
};
...
var propTypes$8 = {
  ...
  className: import_prop_types.default.any,
  cssModule: import_prop_types.default.object
};
var defaultProps$8 = {
  tag: "li"
...
var UncontrolledButtonDropdown = class extends import_react.Component {
  ...
  render() {
    return import_react.default.createElement(ButtonDropdown$1, _extends({
      isOpen: this.state.isOpen,
      toggle: this.toggle
