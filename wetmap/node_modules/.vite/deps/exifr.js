...
function l(e2, t2 = o) {
  if (n)
    try {
      return typeof __require == "function" ? Promise.resolve(t2(__require(e2))) : import(
        /* webpackIgnore: true */
        e2
      ).then(t2);
    } catch (t3) {
...
if (!e.fetch) {
  const e2 = l("http", (e3) => e3), t2 = l("https", (e3) => e3), i2 = (n2, { headers: s2 } = {}) => new Promise(async (r2, a2) => {
    ...
    const d2 = (u2 === "https:" ? await t2 : await e2).request(f2, (e3) => {
...
var y = typeof TextDecoder != "undefined" ? new TextDecoder("utf-8") : void 0;
function b(e2) {
...
async function st(e2, t2, i2) {
  let n2 = new q(t2);
  n2.chunked = false, i2 === void 0 && typeof e2 == "string" && (i2 = function(e3) {
    let t3 = e3.toLowerCase().split(".").pop();
    if (function(e4) {
      return e4 === "exif" || e4 === "tiff" || e4 === "tif";
    }(t3))
      return "tiff";
    if (it.includes(t3))
      return t3;
...
var pt = class extends re {
  ...
  parseTags() {
    ...
    for (; a2--; ) {
      ...
      s2 = this.parseTag(n2, t2, i2), s2 !== void 0 && s2 !== "\0\0\0\0" && r2.set(e2, s2), o2 += 12;
    }
  }
  parseTag(e2, t2, i2) {
    switch (e2) {
...
// dep:exifr
var exifr_default = full_esm_default;
export {
  te as Exifr,
  q as Options,
  X as allFormatters,
